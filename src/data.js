...
let mammals = [
    ...
    new Animal(
        ...
        10,
        "Tasmania",
        getImageURL("tasmanian-devil.png")
    ),
    new Animal(
        "Quokka",
        10,
...
let reptiles = [
    new Animal(
        ...
        1,
        "Northern Australia",
        getImageURL("frill-neck-lizard.png")
    ),
    new Animal(
        "Hawksbill Turtle",
        50,
        ...
        getImageURL("hawkbill-turtle.png")
    ),
    new Animal(
        "Perentie",
        20,
...
let birds = [
    ...
    new Animal(
        ...
        900 / 1000,
        "SE Australia",
        getImageURL("yellow-tailed-black-cockatoo.PNG")
    )
]
